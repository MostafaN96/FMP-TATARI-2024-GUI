...
@Component({
  selector: 'app-transition-between-orders-requisition-show-all-we',
  templateUrl: './transition-between-orders-requisition-show-all-we.component.html',
  styleUrls: ['./transition-between-orders-requisition-show-all-we.component.css']
})
export class TransitionBetweenOrdersRequisitionShowAllWeComponent {
  ...
  getData() {
  this.loading = true;
    this._transitionBetweenOrdersRequisitionWeService.selectAll().subscribe((response: any) => {
