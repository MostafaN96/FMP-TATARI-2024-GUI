...
@Component({
  selector: 'app-manufacturing-order-requisition-add-details-form-wb',
  templateUrl: './manufacturing-order-requisition-add-details-form-wb.component.html',
  styleUrls: ['./manufacturing-order-requisition-add-details-form-wb.component.css']
})
export class ManufacturingOrderRequisitionAddDetailsFormWbComponent implements OnInit {
  ...
  async onAddRequisition() {
    ...
    if (this.addOrderForm.valid) {
      ...
      this._manufacturingOrderRequisitionWbService.addDetails(formGroup.value).subscribe(response => {
