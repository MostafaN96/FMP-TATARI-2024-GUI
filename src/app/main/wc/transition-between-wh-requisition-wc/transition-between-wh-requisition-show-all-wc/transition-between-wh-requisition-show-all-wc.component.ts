...
@Component({
  selector: 'app-transition-between-wh-requisition-show-all-wc',
  templateUrl: './transition-between-wh-requisition-show-all-wc.component.html',
  styleUrls: ['./transition-between-wh-requisition-show-all-wc.component.css']
})
export class TransitionBetweenWhRequisitionShowAllWcComponent implements OnInit {
...
getData() {
this.loading = true;
  this._transitionBetweenWhRequisitionWcService.selectAll().subscribe((response: any) => {
