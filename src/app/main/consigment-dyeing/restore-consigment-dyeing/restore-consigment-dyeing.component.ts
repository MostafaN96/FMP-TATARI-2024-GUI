...
@Component({
  selector: 'app-restore-consigment-dyeing',
  templateUrl: './restore-consigment-dyeing.component.html',
  styleUrls: ['./restore-consigment-dyeing.component.css']
})
export class RestoreConsigmentDyeingComponent implements OnInit {

 
  /////////////////// Variables ///////////////////
  consigmentDyeing: any[] = []
  selectedData:any = []
  ...
  getData() {
    this._consigmentDyeingService.selectAllDeleted().subscribe((response: any) => {
      this.consigmentDyeing = response
      this.dataSourceSearchTabel = new MatTableDataSource(this.consigmentDyeing);
  ...
  selectAll() {
    this.consigmentDyeing.forEach(consigmentDyeing => {
      this.getSelectedIndex(consigmentDyeing)
    })
  }
  ...
  restore() {
    ...
    this._consigmentDyeingService.restore(this.selectedData).subscribe(response => {
