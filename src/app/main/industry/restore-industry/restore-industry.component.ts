...
@Component({
  selector: 'app-restore-industry',
  templateUrl: './restore-industry.component.html',
  styleUrls: ['./restore-industry.component.css']
})
export class RestoreIndustryComponent implements OnInit {
  ...
  getData() {
    this._industryService.selectAllDeleted().subscribe((response: any) => {
  ...
  restore() {
    ...
    this._industryService.restore(this.selectedData).subscribe(response => {
