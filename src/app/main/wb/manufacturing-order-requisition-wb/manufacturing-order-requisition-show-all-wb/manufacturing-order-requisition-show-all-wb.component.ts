...
@Component({
  selector: 'app-manufacturing-order-requisition-show-all-wb',
  templateUrl: './manufacturing-order-requisition-show-all-wb.component.html',
  styleUrls: ['./manufacturing-order-requisition-show-all-wb.component.css'],
  providers: [ConfirmationService]
})
export class ManufacturingOrderRequisitionShowAllWbComponent implements OnInit {
  ...
  ngOnInit(): void {
    if(this.router.url === '/dashboard/show-all-closed-manufacturing-order-requisition-wb') {
      this.getData("closed")
    }
    else {
      this.getData()
  ...
  getData(isClosed?:string) {
    this._manufacturingOrderRequisitionWbService.selectAll(isClosed).subscribe((response: any) => {
  ...
  closeOrder(data) {
    ...
    this._manufacturingOrderRequisitionWbService.closeOrderByRequisition(data.id).subscribe((response: any) => {
