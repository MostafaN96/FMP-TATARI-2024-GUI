...
@Component({
  selector: 'app-item-hostory-by-dyed-fabric-details-total-we',
  templateUrl: './item-hostory-by-dyed-fabric-details-total-we.component.html',
  styleUrls: ['./item-hostory-by-dyed-fabric-details-total-we.component.css']
})
export class ItemHostoryByDyedFabricDetailsTotalWeComponent implements OnInit {
  ...
  getData() {
    ...
    this.route.queryParams
      .subscribe(params => {
        ...
        this._reportWeService.selectInventoryTotalByFabric(params['id']).subscribe((response: any) => {
