...
// Call Service
import { ReconcilitionRequisitionWdService } from "../../../../services/main/wd/reconcilition-requisition-wd.service";

@Component({
  selector: 'app-show-all-reconcilition-requisition-wd',
  templateUrl: './show-all-reconcilition-requisition-wd.component.html',
  styleUrls: ['./show-all-reconcilition-requisition-wd.component.css']
})
export class ShowAllReconcilitionRequisitionWdComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._reconcilitionRequisitionWdService.selectAll().subscribe((response: any) => {
