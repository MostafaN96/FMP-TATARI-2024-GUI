...

  {
    path: 'dashboard', component: MainRoutingPageComponent, children:
      ...
      [
        ...
        { path: 'yarn-orders-report', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wa-modules/reports-modules/yarn-orders-report-wa-module/yarn-orders-report-wa-module.module').then(m => m.YarnOrdersReportWaModuleModule) },
        ...
        { path: 'show-all-closed-yarn-order-requisition-wa/details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wa-modules/yarn-order-requisition-wa-modules/yarn-order-requisition-details-wa-module/yarn-order-requisition-details-wa-module.module').then(m => m.YarnOrderRequisitionDetailsWaModuleModule) },
        ...
        { path: 'add-add-requisition-by-order-wc', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wc-modules/add-requisition-wc-modules/add-add-requisition-by-order-wc-module/add-add-requisition-by-order-wc-module.module').then(m => m.AddAddRequisitionByOrderWcModuleModule) },
        { path: 'show-all-add-requisition-wc/order-details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wc-modules/add-requisition-wc-modules/add-requisition-details-by-order-wc-module/add-requisition-details-by-order-wc-module.module').then(m => m.AddRequisitionDetailsByOrderWcModuleModule) },
        ...
        { path: 'show-all-closed-fabric-order-requisition-wc/details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wc-modules/fabric-order-requisition-wc-modules/fabric-order-requisition-details-wc-module/fabric-order-requisition-details-wc-module.module').then(m => m.FabricOrderRequisitionDetailsWcModuleModule) },
        ...
        // Transition Betwen orders Requisition wc 
        ...
        { path: 'report-wc/update-report-wc', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wc-modules/reports-modules/update-report-wc-module/update-report-wc-module.module').then(m => m.UpdateReportWcModuleModule) },
        ...
        { path: 'fabric-orders-report', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wc-modules/reports-modules/fabric-orders-report-wc-module/fabric-orders-report-wc-module.module').then(m => m.FabricOrdersReportWcModuleModule) },
        ...
        { path: 'report-wd/consigment-dyeing-history', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wd-modules/reports-modules/consigment-dyeing-history-report-wd-module/consigment-dyeing-history-report-wd-module.module').then(m => m.ConsigmentDyeingHistoryReportWdModuleModule) },
        ...
        { path: 'show-all-closed-dyed-fabric-order-requisition-we/details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/we-modules/dyed-fabric-order-requisition-we-modules/dyed-fabric-order-requisition-details-we-module/dyed-fabric-order-requisition-details-we-module.module').then(m => m.DyedFabricOrderRequisitionDetailsWeModuleModule) },
        ...
        // Transition Betwen orders Requisition we 
        { path: 'add-transition-between-orders-requisition-we', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/we-modules/transition-between-orders-requisition-we-modules/add-transition-between-orders-requisition-we-module/add-transition-between-orders-requisition-we-module.module').then(m => m.AddTransitionBetweenOrdersRequisitionWeModuleModule) },
        { path: 'show-all-transition-between-orders-requisition-we', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/we-modules/transition-between-orders-requisition-we-modules/transition-between-orders-requisition-show-all-we-module/transition-between-orders-requisition-show-all-we-module.module').then(m => m.TransitionBetweenOrdersRequisitionShowAllWeModuleModule) },
        { path: 'show-all-transition-between-orders-requisition-we/details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/we-modules/transition-between-orders-requisition-we-modules/transition-between-orders-requisition-details-we-module/transition-between-orders-requisition-details-we-module.module').then(m => m.TransitionBetweenOrdersRequisitionDetailsWeModuleModule) },
        ...
        { path: 'general-orders-report', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/reports-modules/general-orders-report-module/general-orders-report-module.module').then(m => m.GeneralOrdersReportModuleModule) },
