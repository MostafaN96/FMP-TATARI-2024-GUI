...
export class DyeingRequisitionDetailsWdService {

  urlService: string = "wd-dyeing-requisition-details/"
  ...
  updateDyeingCostPrice(id: string): Observable<any> {
    let url = `${this._constantsService.BASE_URL}${this.urlService}update-dyeing-cost-price/${id}`;
