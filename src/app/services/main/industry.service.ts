...
export class IndustryService {
  ...
  selectIndustryOfManufacturer(): Observable<any> {
    const url = `${this._constantsService.BASE_URL}${this.urlService}industry-of-manufacturer`;
    return this._http.get(url);
  }
