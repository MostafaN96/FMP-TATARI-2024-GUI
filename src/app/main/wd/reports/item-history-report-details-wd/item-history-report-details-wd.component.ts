...
@Component({
  selector: 'app-item-history-report-details-wd',
  templateUrl: './item-history-report-details-wd.component.html',
  styleUrls: ['./item-history-report-details-wd.component.css']
})
export class ItemHistoryReportDetailsWdComponent implements OnInit {
  ...
  goToRequisitionPage(typeOfRequisition = '', element?) {
    ...
    else if (typeOfRequisition == 'اذن نقل (D) الى (C)') {
