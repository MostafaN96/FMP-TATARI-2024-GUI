...
@Component({
  selector: 'app-add-transition-between-orders-requisition-form-we',
  templateUrl: './add-transition-between-orders-requisition-form-we.component.html',
  styleUrls: ['./add-transition-between-orders-requisition-form-we.component.css']
})
export class AddTransitionBetweenOrdersRequisitionFormWeComponent implements OnInit {
  ...
  getData() {
    this.route.queryParams.subscribe(params => {
      this.addtransitionOrdersRequisitionForm.controls['id'].setValue(params['id'])
    })

    this.addtransitionOrdersRequisitionForm.controls['fabricOrderId'].setValue(this.selectedData?.to_we_dyed_fabric_order_requisition_id)
    this.addtransitionOrdersRequisitionForm.controls['ordersRequisitionsId'].setValue(this.selectedData?.orders_requisitions_id)

    this._weService.selectStoreWeByWeDyedFabricOrderRequisitionIdOfOrderDyedFabrics(this.selectedData?.to_we_dyed_fabric_order_requisition_id).subscribe((response: any) => {
  ...
  async onTransitionBetweenWhRequisition() {
    ...
    if (this.addtransitionOrdersRequisitionForm.valid) {
      ...
      this._transitionBetweenOrdersRequisitionDetailsWeService.add(this.addtransitionOrdersRequisitionForm.value).subscribe(response => {
