...
@Component({
  selector: 'app-add-details-form-by-order-wc',
  templateUrl: './add-details-form-by-order-wc.component.html',
  styleUrls: ['./add-details-form-by-order-wc.component.css']
})
export class AddDetailsFormByOrderWcComponent implements OnInit {
  ...
  getData() {
    ...
    this.addRequisitionWCForm.controls['wcFabricOrderRequisitionId'].setValue(this.selectedData?.wc_fabric_order_requisition_id)
    this.addRequisitionWCForm.controls['ordersRequisitionsId'].setValue(this.selectedData?.orders_requisitions_id)
