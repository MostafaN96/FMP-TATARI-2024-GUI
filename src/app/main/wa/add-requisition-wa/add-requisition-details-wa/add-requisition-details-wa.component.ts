...
@Component({
  selector: 'app-add-requisition-details-wa',
  templateUrl: './add-requisition-details-wa.component.html',
  styleUrls: ['./add-requisition-details-wa.component.css']
})
export class AddRequisitionDetailsWaComponent implements OnInit {
  ...
  getData() {
    this.route.queryParams
      .subscribe(params => {
        this._waAddRequisitionDetailsService.selectByRequisitionId(params['id']).subscribe((response: any) => {
