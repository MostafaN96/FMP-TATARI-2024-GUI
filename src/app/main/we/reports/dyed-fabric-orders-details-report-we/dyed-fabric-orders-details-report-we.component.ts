...
@Component({
  selector: 'app-dyed-fabric-orders-details-report-we',
  templateUrl: './dyed-fabric-orders-details-report-we.component.html',
  styleUrls: ['./dyed-fabric-orders-details-report-we.component.css']
})
export class DyedFabricOrdersDetailsReportWeComponent implements OnInit {
