...
@Component({
  selector: 'app-show-all-add-requisition-we',
  templateUrl: './show-all-add-requisition-we.component.html',
  styleUrls: ['./show-all-add-requisition-we.component.css']
})
export class ShowAllAddRequisitionWeComponent implements OnInit {
  ...
  constructor(
    ...
    private _addRequisitionWeService: AddRequisitionWeService,
  ...
  getData() {
    ...
    this._addRequisitionWeService.selectAll().subscribe((response: any) => {
