...
@Component({
  selector: 'app-inquire-fabric-avilability-shared-details-report-wd',
  templateUrl: './inquire-fabric-avilability-shared-details-report-wd.component.html',
  styleUrls: ['./inquire-fabric-avilability-shared-details-report-wd.component.css']
})
export class InquireFabricAvilabilitySharedDetailsReportWdComponent implements OnInit {
  ...
  getDataByDyeingRequisition(data) {
    this._reportWeService.inquireFabricAvilabilityByDyeingOrderRequisitionReportWe(data).subscribe((response: any) => {
