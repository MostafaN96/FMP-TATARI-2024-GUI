...
@Component({
  selector: 'app-inquire-fabric-avilability-shared-total-report-wd',
  templateUrl: './inquire-fabric-avilability-shared-total-report-wd.component.html',
  styleUrls: ['./inquire-fabric-avilability-shared-total-report-wd.component.css']
})
export class InquireFabricAvilabilitySharedTotalReportWdComponent implements OnInit {
  ...
  getDataByDyeingRequisitionTotal(data) {
    this._reportWeService.inquireFabricAvilabilityByDyeingOrderRequisitionTotalReportWe(data).subscribe((response: any) => {
