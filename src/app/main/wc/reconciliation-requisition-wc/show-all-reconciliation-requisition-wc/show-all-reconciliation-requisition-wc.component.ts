...
// Call Service
import { ReconcilitionRequisitionWcService } from "../../../../services/main/wc/reconcilition-requisition-wc.service";

@Component({
  selector: 'app-show-all-reconciliation-requisition-wc',
  templateUrl: './show-all-reconciliation-requisition-wc.component.html',
  styleUrls: ['./show-all-reconciliation-requisition-wc.component.css']
})
export class ShowAllReconciliationRequisitionWcComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._reconcilitionRequisitionWcService.selectAll().subscribe((response: any) => {
