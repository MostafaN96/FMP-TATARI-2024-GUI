...

  {
    path: 'dashboard', component: MainRoutingPageComponent, children:
      ...
      [
        ...
        { path: 'add-add-requisition-by-order-wa', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wa-modules/add-requisition-order-wa-modules/add-add-requisition-order-wa-module/add-add-requisition-order-wa-module.module').then(m => m.AddAddRequisitionOrderWaModuleModule) },
        { path: 'show-all-add-order-requisition-wa', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wa-modules/add-requisition-order-wa-modules/show-all-requisition-order-wa-module/show-all-requisition-order-wa-module.module').then(m => m.ShowAllRequisitionOrderWaModuleModule) },
        { path: 'show-all-add-order-requisition-wa/order-details', canActivate: [AuthGuard], loadChildren: () => import('./system-modules/main-pages-modules/wa-modules/add-requisition-order-wa-modules/add-requisition-details-order-wa-module/add-requisition-details-order-wa-module.module').then(m => m.AddRequisitionDetailsOrderWaModuleModule) },
