...
@Component({
  selector: 'app-show-all-reconcilition-requisition-we',
  templateUrl: './show-all-reconcilition-requisition-we.component.html',
  styleUrls: ['./show-all-reconcilition-requisition-we.component.css']
})
export class ShowAllReconcilitionRequisitionWeComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._reconcilitionRequisitionWeService.selectAll().subscribe((response: any) => {
