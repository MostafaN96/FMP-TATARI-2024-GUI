...
@Component({
  selector: 'app-bar-chart-report-by-supplier',
  templateUrl: './bar-chart-report-by-supplier.component.html',
  styleUrls: ['./bar-chart-report-by-supplier.component.css']
})
export class BarChartReportBySupplierComponent implements OnInit {
