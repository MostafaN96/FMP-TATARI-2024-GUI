...
@Component({
  selector: 'app-sales-report-we',
  templateUrl: './sales-report-we.component.html',
  styleUrls: ['./sales-report-we.component.css']
})
export class SalesReportWeComponent implements OnInit {
