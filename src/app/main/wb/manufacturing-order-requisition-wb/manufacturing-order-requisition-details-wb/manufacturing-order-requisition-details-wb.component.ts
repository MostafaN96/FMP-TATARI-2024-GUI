...
// Child Components
import { ManufacturingOrderRequisitionUpdateWbComponent } from "../manufacturing-order-requisition-update-wb/manufacturing-order-requisition-update-wb.component";

@Component({
  selector: 'app-manufacturing-order-requisition-details-wb',
  templateUrl: './manufacturing-order-requisition-details-wb.component.html',
  styleUrls: ['./manufacturing-order-requisition-details-wb.component.css']
})
export class ManufacturingOrderRequisitionDetailsWbComponent implements OnInit {

  // Child Components
  @ViewChild('updateOrder') updateOrder: ManufacturingOrderRequisitionUpdateWbComponent | undefined;
  ...
  getData(isClosed?:string) {
    this.route.queryParams
      .subscribe(params => {
        this._manufacturingOrderRequisitionDetailsWbService.select(params['id'], isClosed).subscribe((response: any) => {
