...
@Component({
  selector: 'app-show-all-consigment-dyeing',
  templateUrl: './show-all-consigment-dyeing.component.html',
  styleUrls: ['./show-all-consigment-dyeing.component.css']
})
export class ShowAllConsigmentDyeingComponent implements OnInit {
 ...
 delete() {
   this._consigmentDyeingService.delete(this.selectedData).subscribe(response => {
