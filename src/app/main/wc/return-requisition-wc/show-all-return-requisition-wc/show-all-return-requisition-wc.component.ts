...
// Call Service
import { ReturnRequisitionWcService } from "../../../../services/main/wc/return-requisition-wc.service";

@Component({
  selector: 'app-show-all-return-requisition-wc',
  templateUrl: './show-all-return-requisition-wc.component.html',
  styleUrls: ['./show-all-return-requisition-wc.component.css']
})
export class ShowAllReturnRequisitionWcComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._returnRequisitionWcService.selectAll().subscribe((response: any) => {
