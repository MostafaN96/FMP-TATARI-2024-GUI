...
@Component({
  ...
  templateUrl: './update-manufacturing-output-order.component.html',
  styleUrls: ['./update-manufacturing-output-order.component.css']
})
...
selectCircularKnittingMachine(event: { itemData: any; }) {
  ...
  onUpdate() {
    ...
    this._wbManufacturingOutputService.updateForOrder(this.outputManufacturedWbForm.value, this.selectedData.id).subscribe((response: any) =>{
