...
@Component({
  selector: 'app-show-all-sell-requisition',
  templateUrl: './show-all-sell-requisition.component.html',
  styleUrls: ['./show-all-sell-requisition.component.css']
})
export class ShowAllSellRequisitionComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._sellRequisitionWaService.selectAll().subscribe((response: any) => {
      this.yarns = response
