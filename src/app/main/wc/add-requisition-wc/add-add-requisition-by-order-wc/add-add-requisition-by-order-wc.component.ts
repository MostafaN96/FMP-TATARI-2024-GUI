...
@Component({
  selector: 'app-add-add-requisition-by-order-wc',
  templateUrl: './add-add-requisition-by-order-wc.component.html',
  styleUrls: ['./add-add-requisition-by-order-wc.component.css']
})
export class AddAddRequisitionByOrderWcComponent implements OnInit {
  ...
  selectRequisitionsOrderName(event: { itemData: any; }) {
    if (this.requisitionsOrder.includes(event.itemData)) {
      this.addRequisitionWCForm.controls['ordersRequisitionsId'].setValue(event.itemData.orders_requisitions_id)
    } else {
      this.addRequisitionWCForm.controls['wcFabricOrderRequisitionId'].setValue("")
      this.addRequisitionWCForm.controls['ordersRequisitionsId'].setValue("")
    }
  }
  ...
  async onAddRequisitionWC(){
    ...
    this._addRequisitionWcService.addByOrder(this.addRequisitionWCForm.value).subscribe(response => {
