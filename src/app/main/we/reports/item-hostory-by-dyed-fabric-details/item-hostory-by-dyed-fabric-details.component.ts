...
@Component({
  selector: 'app-item-hostory-by-dyed-fabric-details',
  templateUrl: './item-hostory-by-dyed-fabric-details.component.html',
  styleUrls: ['./item-hostory-by-dyed-fabric-details.component.css']
})
export class ItemHostoryByDyedFabricDetailsComponent implements OnInit {
  ...
  getData() {
    ...
    this.route.queryParams
      .subscribe(params => {
        ...
        this._reportWeService.selectInventoryDetailsByWarehouseByFabric(params['id'], params['warehouseId']).subscribe((response: any) => {
