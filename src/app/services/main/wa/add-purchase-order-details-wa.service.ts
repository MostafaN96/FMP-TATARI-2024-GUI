...
export class AddPurchaseOrderDetailsWaService {

  urlService: string = "wa-purchase-order-details/"
  ...
  // yarnsOfPurchaseOrderWa
  yarnsOfPurchaseOrderWa(purchaseOrderId: string): Observable<any> {
    let url = `${this._constantsService.BASE_URL}${this.urlService}yarns-of-purchase-order/${purchaseOrderId}`;
  ...
  // yarnsOfPurchaseOrderWaNotAdded
  yarnsOfPurchaseOrderWaNotAdded(purchaseOrderId: string, addRequisitionId: string): Observable<any> {
    let url = `${this._constantsService.BASE_URL}${this.urlService}yarns-of-purchase-order-not-added/${purchaseOrderId}/${addRequisitionId}`;
