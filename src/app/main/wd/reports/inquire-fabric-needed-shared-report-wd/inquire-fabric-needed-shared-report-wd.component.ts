...
@Component({
  selector: 'app-inquire-fabric-needed-shared-report-wd',
  templateUrl: './inquire-fabric-needed-shared-report-wd.component.html',
  styleUrls: ['./inquire-fabric-needed-shared-report-wd.component.css']
})
export class InquireFabricNeededSharedReportWdComponent implements OnInit {
  ...
  getDataByDyeingRequisition(data) {
    this._reportWeService.inquireFabricNeededByDyeingOrderRequisitionTotalReportWe(data).subscribe((response: any) => {
