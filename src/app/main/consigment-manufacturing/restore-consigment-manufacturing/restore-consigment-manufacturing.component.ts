...
@Component({
  selector: 'app-restore-consigment-manufacturing',
  templateUrl: './restore-consigment-manufacturing.component.html',
  styleUrls: ['./restore-consigment-manufacturing.component.css']
})
export class RestoreConsigmentManufacturingComponent implements OnInit {
  ...
  getData() {
    this._consigmentManufacturingService.selectAllDeleted().subscribe((response: any) => {
  ...
  restore() {
    ...
    this._consigmentManufacturingService.restore(this.selectedData).subscribe(response => {
