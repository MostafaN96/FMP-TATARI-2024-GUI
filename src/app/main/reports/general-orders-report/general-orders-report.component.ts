...
@Component({
  selector: 'app-general-orders-report',
  templateUrl: './general-orders-report.component.html',
  styleUrls: ['./general-orders-report.component.css']
})
export class GeneralOrdersReportComponent implements OnInit {
  ...
  getData() {
    this.loading = true;
    this._reportWeService.generalOrdersReport().subscribe((response: any) => {
  ...
  goToRequisitionPage(typeOfRequisition) {
    if (typeOfRequisition == 'wa_yarn_order') {
      return `/dashboard/show-all-opened-yarn-order-requisition-wa/details`
    }
    else if (typeOfRequisition == 'wc_fabric_order') {
      return `/dashboard/show-all-opened-fabric-order-requisition-wc/details`
    }
    else if (typeOfRequisition == 'we_dyed_fabric_order') {
      return `/dashboard/show-all-opened-dyed-fabric-order-requisition-we/details`
    }
    return
  }
}
